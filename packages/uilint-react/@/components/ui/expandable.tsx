      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md">
            <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white dark:bg-zinc-100 p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-zinc-200/50 dark:bg-zinc-800 dark:ring-zinc-800/50">
