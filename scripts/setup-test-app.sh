...
echo "Running uilint init --eslint --react --vision --semantic --duplicates --coverage..."
cd "$TEST_APP_DIR" && node "$UILINT_CLI" init --eslint --react --vision --semantic --duplicates --coverage
